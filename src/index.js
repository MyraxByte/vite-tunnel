import devtools, { DEVTOOLS_POPUP_ELEMENT_ID,  DEVTOOLS_TOGGLE_ELEMENT_ID } from "@vite-libs/devtools";
...
export function inject() {
    ...
    devtools.register([{
        ...
        async init(shadowRoot, eventTarget) {
            const modal = document.createElement(DEVTOOLS_POPUP_ELEMENT_ID);
            ...
            const toggle = document.createElement(DEVTOOLS_TOGGLE_ELEMENT_ID);
